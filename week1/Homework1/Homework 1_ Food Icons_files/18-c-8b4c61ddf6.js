(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[18],{"0crz":function(e,t,i){"use strict"
var r=i("ouhR")
var s=i.n(r)
var a=i("pQTu")
var n=i("m0r6")
...
if("html,body"!=this.selector){var p=s()("body").offset()
this.each(function(){try{p=s()(this).offset()
return false}catch(e){}})
o-=p.top
l-=p.top
c-=p.left
u-=p.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){_=s()(window).height()
...
o.a.ajaxJSON(r,"GET",{},e=>{t&&t(e)},e=>{i&&i(e)})}let d
...
t.stopPropagation()
let r=new Date
if("diigo"==e&&d&&r-d<15e3){setTimeout(()=>{i.find("form").submit()},15e3-(r-d))
...
o.a.ajaxJSON(n,"GET",{},e=>{i.find(".results").empty()
...
o.a.ajaxJSON(e.url,"DELETE",s,i=>{e.success.call(t,i)},(i,r,s,a)=>{e.error&&o.a.isFunction(e.error)?e.error.call(t,i,r,s,a):o.a.ajaxJSON.unhandledXHRs.push(r)})}else{e.success||(e.success=function(){t.fadeOut("slow",()=>{t.remove()})})
e.success.call(t)}}
...
//# sourceMappingURL=18-c-8b4c61ddf6.js.map