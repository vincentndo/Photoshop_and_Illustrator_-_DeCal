...
var o=n.a.fn.loadingImg.image_files["normal"]
...
var u=n()(document.createElement("div")).addClass("loading_image_holder")
var d=n()(document.createElement("img")).attr("src",o.url)
u.append(d)
a=t.data("loading_images")||[]
a.push(u)
t.data("loading_images",a)
if(t.css("position")&&"static"!=t.css("position")){u.css({zIndex:l,position:"absolute",top:r,left:s})
t.append(u)}else{var m=t.offset()
var c=m.top,_=m.left
e.vertical&&(c+=r)
e.horizontal&&(_+=s)
...
e.href=r.attr("href")
n=e}catch(e){}if(n&&Object(m["a"])(n.search).no_preview)return
...
const i="".concat(e,"/p/").concat(INST.kalturaSettings.partner_id,"/thumbnail/entry_id/").concat(u,"/width/")+"".concat(s.width,"/height/").concat(s.height,"/bgcolor/000000/type/2/vid_sec/5")
...
let m=r
if(a){m=r.clone().empty().removeClass("instructure_file_link")
const e=r.parent(".instructure_file_link_holder")
e.length?m.appendTo(e):r.after(m)}else r.empty()
m.data("download",m.attr("href")).prop("href","#").addClass("instructure_inline_media_comment").append(n).css({backgroundImage:"",padding:0})}}d.a.fn.mediaCommentThumbnail=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"normal"
...
var o=a("5Ky4")
a("JI1W")
n.a.fn.fillTemplateData=function(e){if(this.length&&e){e.iterator&&this.find("*").andSelf().each(function(){var t=n()(this)
n.a.each(["name","id","class"],(a,i)=>{t.attr(i)&&t.attr(i,t.attr(i).replace(/-iterator-/,e.iterator))})})
e.id&&this.attr("id",e.id)
var t=false
if(e.data)for(var a in e.data){if(e.except&&-1!=n.a.inArray(a,e.except))continue
e.data[a]&&e.dataValues&&-1!=n.a.inArray(a,e.dataValues)&&this.data(a,e.data[a].toString())
var i=this.find("."+a)
var r=e.avoid||""
i.each(function(){var i=n()(this)
if(i.length>0&&0===i.closest(r).length){"undefined"!=typeof e.data[a]&&null!==e.data[a]||(e.data[a]="")
if(e.htmlValues&&-1!=n.a.inArray(a,e.htmlValues)){i.html(n.a.raw(e.data[a].toString()))
...
i.html(Object(o["a"])(s))}catch(e){}}})}e.hrefValues&&e.data&&this.find("a,span[rel]").each(function(){var t,a,i,o=n()(this)
for(var r in e.hrefValues){if(!e.hrefValues.hasOwnProperty(r))continue
var s=e.hrefValues[r]
if(t=o.attr("href")){var l=n.a.replaceTags(t,s,encodeURIComponent(e.data[s]))
var u=o.text()===o.html()?o.text():null
if(t!==l){o.attr("href",l)
u&&o.text(u)}}(a=o.attr("rel"))&&o.attr("rel",n.a.replaceTags(a,s,e.data[s]));(i=o.attr("name"))&&o.attr("name",n.a.replaceTags(i,s,e.data[s]))}})
t&&n()(document).triggerHandler("user_content_change")}return this}
...
o=null
o=r.hasClass("user_content")&&r.data("unenhanced_content_html")?r.data("unenhanced_content_html"):n.a.trim(r.html())
a[e.htmlValues[t]]=o}return a}
n.a.fn.getTemplateValue=function(e,t){var a=n.a.extend({},t,{textValues:[e]})
...
e.addClass("youtubed").after(i)}}Object(v["a"])("Route",location.pathname.replace(/\/$/,"").replace(/\d+/g,"--")||"/")
...
setTimeout(()=>{l()(".user_content form.user_content_post_form:not(.submitted)").submit().addClass("submitted")},10)}l()(function(){if(window._earlyClick){document.removeEventListener("click",window._earlyClick)
window._earlyClick.clicks&&setTimeout(function(){l.a.each(d.a.uniq(window._earlyClick.clicks),function(){var e=l.a.Event("click")
e.preventDefault()
l()(this).trigger(e)})},1)}const e=l()("#breadcrumbs")
if(e.length){let t
let a=false
const i=1.5*e.find("li:visible:first").height()
const n=()=>{let n=500
...
n()
l()(window).resize(n)}i["a"].prototype.bindOpenKeys.call({$el:l()("#keyboard_navigation")})
...
var a=t.find("iframe")
setTimeout(()=>{a.css("background","#fff")},2500)
l()("body").append(t)
...
l.a.ajaxJSON(t.attr("href").replace(/\/download/,""),"GET",{},a=>{var i=a&&a.attachment
t.loadingImage("remove")
if(i&&(l.a.isPreviewable(i.content_type,"google")||i.canvadoc_session_url)){var n=l()("<div>").insertAfter(t.parents(".link_holder:last")).loadDocPreview({canvadoc_session_url:i.canvadoc_session_url,mimeType:i.content_type,public_url:i.public_url,attachment_preview_processing:"pending_upload"==i.workflow_state||"processing"==i.workflow_state})
var o=l()('<a href="#" style="font-size: 0.8em;" class="hide_file_preview_link">'+Object(c["a"])(r.t("links.minimize_file_preview","Minimize File Preview"))+"</a>").click(e=>{e.preventDefault()
t.show()
t.focus()
n.remove()
...
l()(()=>{setInterval(b,15e3)
setTimeout(b,15)})
l()(".zone_cached_datetime").each(function(){if(l()(this).attr("title")){var e=m["a"].parse(l()(this).attr("title"))
...
var i=t.find(".communication_sub_message.blank").clone(true).removeClass("blank")
a.before(i.show())
var n=d.a.uniqueId("textarea_")
...
"/"===location.pathname&&Object(v["a"])("dashboard_comment","create")},error:function(e){l()(this).loadingImage("remove")
...
var i=null
for(var n in e){var o=e[n].submission
o.user_id==a&&(i=o)}if(i){var r=i.submission_comments[i.submission_comments.length-1].submission_comment
...
l()(document).triggerHandler("user_content_change")
l()(this).remove()
location.href.match(/dashboard/)&&Object(v["a"])("dashboard_comment","create")},error:function(e){l()(this).loadingImage("remove")
l()(this).find("button").attr("disabled",false)
...
this.find(".context_select").change(function(){var e=l()(this),t=e.val(),a=e.parents(".communication_message"),i=a.find("form")
...
if(l()(this).hasClass("discussion_topic_form")){var i=e.discussion_topic
i.context_code=a
i.user_name=l()("#identity .user_name").text()
i.post_date=l.a.datetimeString(i.created_at)
i.topic_id=i.id
var n=l()(this).parents(".communication_message").find(".template")
var o=n.find(".communication_message").clone(true)
...
var r={discussion_topic_id:i.id}
...
l()(this).hide()})
var n=[]
function o(){n=l()(".time_ago_date:visible").toArray()
s()}function s(){var e=n.shift()
if(e){var t=l()(e),a=t.data("parsed_date")||Date.parse(t.data("timestamp")||"")
if(a){var i=new Date-a
t.data("timestamp",a.toISOString())
t.data("parsed_date",a)
var u=l.a.fudgeDateForProfileTimezone(a)
var d=u.toString("MMM d, yyyy")+u.toString(" h:mmtt").toLowerCase()
var m=d
if(i<864e5)if(i<36e5)if(i<6e4)m=r.t("#time.less_than_a_minute_ago","less than a minute ago")
else{var c=parseInt(i/6e4,10)
m=r.t("#time.count_minutes_ago",{one:"1 minute ago",other:"%{count} minutes ago"},{count:c})}else{var _=parseInt(i/36e5,10)
m=r.t("#time.count_hours_ago",{one:"1 hour ago",other:"%{count} hours ago"},{count:_})}t.text(m)
t.attr("title",d)}setTimeout(s,1)}else setTimeout(o,6e4)}setTimeout(o,100)
var u=l()("#sequence_footer .sequence_details_url").filter(":last").attr("href")
if(u)l.a.ajaxJSON(u,"GET",{},e=>{var t=l()("#sequence_footer")
if(e.current_item){l()("#sequence_details .current").fillTemplateData({data:e.current_item.content_tag})
l.a.each({previous:".prev",next:".next"},(a,i)=>{var n=t.find(i)
...
n.addClass("module_button")}n.fillTemplateData({data:o})
e[a+"_item"]?n.attr("href",l.a.replaceTags(t.find(".module_item_url").attr("href"),"id",o.id)):n.attr("href",l.a.replaceTags(t.find(".module_url").attr("href"),"id",o.id)+"/items/"+("previous"===a?"last":"first"))}else n.hide()})
t.show()
l()(window).resize()}})
else{var _=l()("#sequence_footer")
if(_.length){var g=l()(_[0])
Promise.all([a.e(7),a.e(66),a.e(578)]).then(a.bind(null,"/j35")).then(()=>{g.moduleSequenceFooter({courseID:g.attr("data-course-id"),assetType:g.attr("data-asset-type"),assetID:g.attr("data-asset-id")})})}}l()("#right-side").delegate(".more_link","click",function(e){var t=l()(this)
...
var i=a.find(".disable-todo-item-link").length&&a.find(".disable-todo-item-link")||l()(".todo-list-header")
var n=l()(this).data("api-href")
...
Object(d["a"])("Doc Previews",e,JSON.stringify(a,["attachment_id","submission_id","mimetype","crocodoc_session_url","canvadoc_session_url"]))}}if(!i["a"].disableCrocodocPreviews&&a.crocodoc_session_url){const e=Object(m["a"])(a.crocodoc_session_url)
...
const r=Object(m["a"])(a.canvadoc_session_url)
o=l()("<iframe/>",{src:r,width:a.width,allowfullscreen:"1",css:{border:0,overflow:"auto",height:"99%","min-height":i},id:a.id})
o.appendTo(e)
o.load(()=>{n("canvadocs")
l.a.isFunction(a.ready)&&a.ready()})}else if(!i["a"].disableGooglePreviews&&(!a.mimetype||l.a.isPreviewable(a.mimetype,"google"))&&a.attachment_id||a.public_url){var s=function(){var e="//docs.google.com/viewer?"+l.a.param({embedded:true,url:a.public_url})
...
t.loadingImage()
l.a.ajaxJSON(c,"GET",{},e=>{t.loadingImage("remove")
...
e.replace(/\+/g," ").split("&").forEach(e=>{let n=e.split("="),r=Object(i["a"])(n,2),s=r[0],l=r[1]
s=decodeURIComponent(s)
l=decodeURIComponent(l)
t&&(l=l&&!isNaN(l)?+l:"undefined"===l?void 0:void 0!==o[l]?o[l]:l)
a[s]=l})
return Object(n["a"])(a)}},rnoQ:function(e,t,a){"use strict"
var i=a("pQTu")
var n=a("m0r6")
Object(n["a"])(JSON.parse('{"ar":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"اختصارات لوحة المفاتيح"}}},"cy":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Bysellau Hwylus"}}},"da":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Genvejstaster"}}},"el":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Συντομεύσεις πληκτρολογίου"}}},"en-AU":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Keyboard Shortcuts"}}},"en-AU-x-unimelb":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Keyboard Shortcuts"}}},"en-CA":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Keyboard Shortcuts"}}},"en-GB":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Keyboard shortcuts"}}},"en-GB-x-ukhe":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Keyboard shortcuts"}}},"fa":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"میانبرهای صفحه کلید"}}},"fr-CA":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Raccourcis clavier"}}},"he":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"קיצורי מקלדת"}}},"hu":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Billentyűparancsok"}}},"hy":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Արագ հասանելիության ստեղներ"}}},"is":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Flýtilyklar"}}},"ko":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"키보드 단축키"}}},"mi":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Pokatata papapātuhi"}}},"nb":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Snarveier"}}},"nl":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Sneltoetsen"}}},"nn":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Hurtigtastar"}}},"pl":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Skróty klawiaturowe"}}},"pt":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Atalhos de teclado"}}},"pt-BR":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Atalhos de Teclado"}}},"ru":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Клавиши быстрого доступа"}}},"tr":{"KeyboardNavDialog":{"titles":{"keyboard_shortcuts":"Klavye Kısayolları"}}}}'))
a("jQeR")
a("0sPK")
...
//# sourceMappingURL=112-c-d4d5a6af2a.js.map