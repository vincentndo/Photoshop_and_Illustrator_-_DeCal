(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[59,561],{"13m+":function(e,t,o){"use strict"
var c=o("17x9")
var l=o.n(c)
var a=o("v0Tn")
...
return c["default"].get(e).then(e=>{const c=o.concat(e.data)
const a=t-1
...
return c["default"].put("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/update_associations"),{course_ids_to_add:o.map(e=>e.id),course_ids_to_remove:l.map(e=>e.id)})},getMigrations(e){let t=e.masterCourse
return c["default"].get("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/migrations"))},beginMigration(e){let t=e.masterCourse,o=e.willSendNotification,l=e.willIncludeCustomNotificationMessage,a=e.notificationMessage,i=e.willIncludeCourseSettings
const n={send_notification:o}
i&&(n.copy_settings=true)
l&&a&&(n.comment=a)
return c["default"].post("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/migrations"),n)},checkMigration(e){return this.getMigrations(e).then(e=>{let t=a["a"].void
...
return c["default"].get("/api/v1/courses/".concat(o.id,"/").concat(a,"/").concat(n,"/migrations/").concat(r))},getMigrationDetails(e,t){let o=e.course
let l=t.blueprintType,a=void 0===l?"blueprint_templates":l,i=t.templateId,n=void 0===i?"default":i,r=t.changeId
return c["default"].get("/api/v1/courses/".concat(o.id,"/").concat(a,"/").concat(n,"/migrations/").concat(r,"/details"))},getFullMigration(e,t){let o=e.course
...
return c["default"].put("/api/v1/courses/".concat(t,"/blueprint_templates/default/restrict_item"),{content_type:o,content_id:l,restricted:a})},loadUnsyncedChanges(e){let t=e.masterCourse
...
var w=o("OAMf")
o("13m+")
class O extends s["Component"]{static setupRootNode(){const e=document.createElement("div")
e.id="blueprint-lock-banner"
e.setAttribute("style","margin-bottom: 2em")
const t=document.querySelector("#content")
return t.insertBefore(e,t.firstChild)}componentDidUpdate(e){this.props.isLocked&&!e.isLocked&&_.a.screenReaderFlashMessage(h.t("%{attributes} locked",{attributes:Object(w["a"])(this.props.itemLocks)}))}render(){if(this.props.isLocked)return Object(c["a"])(v.a,{},void 0,Object(c["a"])(C.a,{weight:"bold",size:"small"},void 0,h.t("Locked:")," "),Object(c["a"])(C.a,{size:"small"},void 0,Object(w["a"])(this.props.itemLocks)))
...
var q=a["default"].scoped("blueprint_coursesLockToggle")
var E=o("VMdx")
var A=o.n(E)
var S=o("X9ng")
var y=o.n(S)
...
var N=o("zkte")
var M=o.n(N)
const x={ADMIN_LOCKED:{label:q.t("Locked"),icon:R.a,tooltip:q.t("Unlock"),variant:"primary"},ADMIN_UNLOCKED:{label:q.t("Blueprint"),icon:M.a,tooltip:q.t("Lock"),variant:"default"},ADMIN_WILLUNLOCK:{label:q.t("Blueprint"),icon:M.a,tooltip:q.t("Unlock"),variant:"default"},ADMIN_WILLLOCK:{label:q.t("Locked"),icon:R.a,tooltip:q.t("Lock"),variant:"primary"},TEACH_LOCKED:{label:q.t("Locked"),icon:R.a},TEACH_UNLOCKED:{label:q.t("Blueprint"),icon:M.a}}
class z extends s["Component"]{static setupRootNode(e,t,o){const c=document.createElement("span")
...
this.onEnter=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?x.ADMIN_WILLUNLOCK:x.ADMIN_WILLLOCK})}
this.onExit=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?x.ADMIN_LOCKED:x.ADMIN_UNLOCKED})}
this.state={}
e.isToggleable?this.state.mode=e.isLocked?x.ADMIN_LOCKED:x.ADMIN_UNLOCKED:this.state.mode=e.isLocked?x.TEACH_LOCKED:x.TEACH_UNLOCKED}render(){const e=this.state.mode.icon
...
const i=this.props.isLocked?q.t("Locked. Click to unlock."):q.t("Unlocked. Click to lock.")
o=Object(c["a"])(y.a,{tip:a,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,Object(c["a"])(A.a,{variant:l,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,Object(c["a"])(e,{}),Object(c["a"])(j.a,{},void 0,t),Object(c["a"])(B.a,{},void 0,i)))}else o=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(e,{})),Object(c["a"])(C.a,{size:"small"},void 0,t))
return Object(c["a"])("span",{className:"bpc-lock-toggle"},void 0,o)}}z.defaultProps={isToggleable:false,onClick:()=>{}}
o.d(t,"default",function(){return V})
function U(e,t){var o=Object.keys(e)
if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(e)
t&&(c=c.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))
o.push.apply(o,c)}return o}function K(e){for(var t=1;t<arguments.length;t++){var o=null!=arguments[t]?arguments[t]:{}
t%2?U(o,true).forEach(function(t){Object(l["a"])(e,t,o[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(o)):U(o).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(o,t))})}return e}class V{constructor(){this.toggleLocked=()=>{const e=this.props.itemType
...
this.render()}getItemLocks(){return K({},this.state.itemLocks)}isMasterContent(){return this.state.isMasterContent}isChildContent(){return this.state.isChildContent}showToggleError(){_.a.flashError(n.t("There was a problem toggling the content lock."))}setupToggle(e){if(!this.props.toggleWrapperSelector)return
this.toggleNode?e():z.setupRootNode(this.props.toggleWrapperSelector,this.props.toggleWrapperChildIndex||0,t=>{this.toggleNode=t
e()})}renderLockToggle(){if(!this.props.toggleWrapperSelector)return
this.setupToggle(()=>{d.a.render(Object(c["a"])(z,{isLocked:this.state.isLocked,isToggleable:"show"===this.props.page&&this.state.isMasterContent,onClick:this.toggleLocked}),this.toggleNode)})}renderBanner(){this.bannerNode||(this.bannerNode=O.setupRootNode())
d.a.render(Object(c["a"])(O,{isLocked:this.state.isLocked,itemLocks:this.state.itemLocks}),this.bannerNode)}render(){this.renderBanner()
this.renderLockToggle()}}},zkte:function(e,t,o){"use strict"
var c=o("284h")
var l=o("TqRt")
...
b.variant="Solid"
b.propTypes=(0,a.default)({},d.default.propTypes)}}])

//# sourceMappingURL=59-c-c15c0ace4f.js.map