...
null!=n&&(a[n]=true)}for(var s=0;s<e.length;s++){var r=e[s]
if(null==r[0]||!a[r[0]]){i&&!r[2]?r[2]=i:i&&(r[2]="(".concat(r[2],") and (").concat(i,")"))
t.push(r)}}}
return t}
...
var s=a.sources.map(function(e){return"/*# sourceURL=".concat(a.sourceRoot).concat(e," */")})
...
return"/*# ".concat(i," */")}},KY2I:function(e,t){(function(e){"use strict"
...
return this},determinePlayback:function(e,t,i,o,n){var s,r,l,d,u,c,m,p,f,h,g,_=[],b={method:"",url:"",htmlMediaElement:e,isVideo:"audio"!==e.tagName.toLowerCase(),scheme:""}
if("undefined"!=typeof t.type&&""!==t.type)if("string"==typeof t.type)_.push({type:t.type,url:n})
else for(s=0;s<t.type.length;s++)_.push({type:t.type[s],url:n})
else if(null!==n){c=this.formatType(n,e.getAttribute("type"))
_.push({type:c,url:n})}else for(s=0;s<e.childNodes.length;s++){u=e.childNodes[s]
...
b.htmlMediaElement=e=h}for(s=0;s<_.length;s++)if("video/m3u8"==_[s].type||""!==e.canPlayType(_[s].type).replace(/no/,"")||""!==e.canPlayType(_[s].type.replace(/mp3/,"mpeg")).replace(/no/,"")||""!==e.canPlayType(_[s].type.replace(/m4a/,"mp4")).replace(/no/,"")){b.method="native"
b.url=_[s].url
break}if("native"===b.method){null!==b.url&&(e.src=b.url)
if("auto_plugin"!==t.mode)return b}}if("auto"===t.mode||"auto_plugin"===t.mode||"shim"===t.mode)for(s=0;s<_.length;s++){c=_[s].type
...
void 0===e["pt-BR"]&&(e["pt-BR"]={"mejs.plural-form":2,"mejs.download-file":"Baixar arquivo","mejs.fullscreen-off":"Sair da tela inteira","mejs.fullscreen-on":"Ir para tela inteira","mejs.download-video":"Baixar vídeo","mejs.fullscreen":"Tela inteira","mejs.close":"Fechar","mejs.captions-subtitles":"Legendas","mejs.none":"Sem legendas","mejs.mute-toggle":"Alternar silêncio","mejs.unmute":"Tirar silêncio","mejs.mute":"Silenciar"})})(mejs.i18n.locale.strings)},UYA0:function(e,t,i){t=e.exports=i("JPst")(false)
...
t.speedButton=r=e(v).appendTo(i)
...
r.find("button").html(_(t)).attr("aria-label",b(t))
...
t.captionsButton.hover(()=>{clearTimeout(p)
t.showCaptionsSelector()},()=>{p=setTimeout(()=>{t.hideCaptionsSelector()},l.options.menuTimeoutMouseLeave)}).on("keydown",function(i){if("a"===i.target.tagName.toLowerCase())return true
var a=i.keyCode
...
e(this).find("button").focus()
break
default:return true}}).on("focusout",mejs.Utility.debounce(i=>{setTimeout(()=>{var i=e(document.activeElement).closest(".mejs-captions-selector")
...
Promise.all([i.e(7),i.e(569)]).then(i.bind(null,"z8T/")).then(e=>{let i=e.default
...
"undefined"==typeof o||"undefined"==typeof o.fadeIn?i.slides.entries.imgs[t]=o=e('<img src="'+a+'">').on("load",()=>{o.appendTo(i.slidesContainer).hide().fadeIn().siblings(":visible").fadeOut()}):o.is(":visible")||o.is(":animated")||o.fadeIn().siblings(":visible").fadeOut()},displaySlides:function(){if("undefined"==typeof this.slides)return
...
var m=i.n(c)
var p=i("LvDl")
const f={ENTER:13,ESC:27,SPACE:32,LEFT:37,UP:38,RIGHT:39,DOWN:40,PAGE_UP:33,PAGE_DOWN:34,M:77,F:70,G_REWIND:227,G_FORWARD:228}
const h={captions:".mejs-captions-button",fullscreen:".mejs-fullscreen-button",playpause:".mejs-playpause-button",progress:".mejs-time-rail",source:".mejs-sourcechooser-button",speed:".mejs-speed-button",volume:".mejs-volume-button"}
function g(e,t){const i=e.filter(t).first()
const a=e.index(i)
...
this.isFirefox=e.MediaFeatures.isFirefox}_.keyCodes=f
_.prototype._targetControl=function(e){return m()(this.event.target).closest(e)}
_.prototype.handlerKey=function(){const e=this
const t=Object(p["findKey"])(h,t=>e._targetControl(t).length)
return t||"player"}
...
const o=g(a,(e,i)=>"none"===i.value&&null==t.selectedTrack||t.selectedTrack&&i.value===t.selectedTrack.srclang)
...
const a=g(i,(e,i)=>i.value===t.media.src)
...
const a=g(i,(e,i)=>parseFloat(i.value)===t.media.playbackRate)
switch(this.keyCode){case f.DOWN:e=Math.min(a+1,i.length-1)
i.slice(e).first().focus().click()
break
case f.UP:e=Math.max(a-1,0)
...
var v=i("5Ky4")
var y=i("Vj0+")
const j={getElement(e,t,i,a){const o="video"===e?' width="'.concat(i,'" height="').concat(a,'"'):""
...
u["a"].MepDefaults.success=function(e,t){i.e(579).then(i.bind(null,"ozaW")).then(t=>{let i=t.default
i(this.mediaCommentId,e,INST.kalturaSettings)})
return e.play()}
u["a"].MepDefaults.features.push("googleanalytics")
const x=u["a"].MepDefaults.features.indexOf("tracks")+1
u["a"].MepDefaults.features.splice(x,0,"sourcechooser")
u["a"].MepDefaults.features.splice(x,0,"speed")
function T(e){const t=new m.a.Deferred
m.a.getJSON("/media_objects/".concat(e,"/info"),e=>{const i=e.media_sources.filter(e=>"audio/mp3"!==e.content_type).map(e=>"<source\n        type='".concat(Object(v["a"])(e.content_type),"'\n        src='").concat(Object(y["a"])(Object(v["a"])(e.url)),"'\n        title='").concat(Object(v["a"])(e.width),"x").concat(Object(v["a"])(e.height)," ").concat(Object(v["a"])(Math.floor(e.bitrate/1024))," kbps'\n      />"))
const a=r.a.map(e.media_tracks,e=>{const t=u["a"].language.codes[e.locale]||e.locale
return"<track kind='".concat(Object(v["a"])(e.kind),"' label='").concat(Object(v["a"])(t),"' src='").concat(Object(v["a"])(e.url),"' srclang='").concat(Object(v["a"])(e.locale),"' />")})
...
return t}function S(e){let t=e.sourcesAndTracks,i=e.mediaType,a=e.height,o=e.width,n=e.mediaPlayerOptions
...
n.mode="auto_plugin"
n.isVideo=false
n.videoHeight=a=30}return j.getElement(s,r,o,a)}const C={create(e,t,i,a){m()("#media_recorder_container").removeAttr("id")
...
return T(e).done(s=>{if(s.sources.length){const n={can_add_captions:s.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e,menuTimeoutMouseLeave:50,success(e){i.focus()
e.play()},keyActions:[{keys:r.a.values(b.keyCodes),action(e,t,i,a){if(e.isVideo){e.showControls()
e.startControlsTimer()}const o=new b(u["a"],e,t,a)
o.dispatch()}}]}
const l=S({sourcesAndTracks:s,mediaPlayerOptions:n,mediaType:t,height:o,width:a})
l.appendTo(i.html(""))
...
const s=function(e){if(e.attachment&&"maybe"!==e.attachment.media_entry_id){a.text("")
return o(e.attachment.media_entry_id,a)}return t()}
return m.a.ajaxJSON(e,"GET",{},s,t)}return o(e,a)},show(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"video"
...
if("video"===t){o=426
s=k}else{o=180
s=400}const r=m()('<div style="overflow: hidden; padding: 0;" />')
"audio"===t&&r.css("padding-top","120px")
r.dialog({dialogClass:"play_media_comment",title:n.t("titles.play_comment","Play Media Comment"),width:s,height:o+60,modal:false,resizable:false,close:()=>{const e=a.data("mediaelementplayer")
e&&e.pause()
...
return r.disableWhileLoading(T(e).done(i=>{if(i.sources.length){const n={can_add_captions:i.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e}
const l=S({sourcesAndTracks:i,mediaPlayerOptions:n,mediaType:t,height:o,width:s})
l.appendTo(r.html(""))
a.data({mediaelementplayer:new MediaElementPlayer(l,n),media_comment_dialog:r})}else r.text(n.t("media_still_converting","Media is currently being converted, please try again in a little bit."))}))}o.dialog("open")}}
...
var _=false
var b=null
c.a.mediaComment.init=function(e,t){Promise.all([i.e(7),i.e(19),i.e(213),i.e(345)]).then((()=>{var a=i("ufgb")
b=b||new Date
e=e||"any"
t=t||{}
...
o=d.data("uid")||"ANONYMOUS"}c()("#video_record_title,#audio_record_title").val(s)
...
var u={align:"middle",quality:"high",bgcolor:"#ffffff",name:"KUpload",allowScriptAccess:"always",type:"application/x-shockwave-flash",pluginspage:"http://www.adobe.com/go/getflashplayer",wmode:"transparent"}
...
const n=o();("Chrome"===n.name&&Number(n.version)>=68||"Firefox"===n.name&&Number(n.version)>=61)&&Promise.all([i.e(1),i.e(5),i.e(22),i.e(30),i.e(56),i.e(75),i.e(81),i.e(556)]).then(i.bind(null,"kImW")).then(e=>{let t=e.default
let i
const a=()=>{const e=document.getElementById("record_media_tab")
if(e){t(e,f.doUploadByFile)
clearInterval(i)}}
i=setInterval(a,10)})}var l=new Date
l-b>3e5&&c()("#media_comment_dialog").dialog("close").remove()
b=l
var d=c()("#media_comment_dialog")
if(0!=d.length||INST.kalturaSettings.js_uploader)INST.kalturaSettings.js_uploader||r()
else{var u=c()("<div/>").attr("id","media_comment_dialog")
u.text(n.t("messages.loading","Loading..."))
u.dialog({title:n.t("titles.record_upload_media_comment","Record/Upload Media Comment"),resizable:false,width:470,height:300,modal:true})
c.a.ajaxJSON("/api/v1/services/kaltura_session","POST",{},e=>{u.data("ks",e.ks)
u.data("uid",e.uid)},e=>{false==e.logged_in?u.data("ks-error",n.t("errors.must_be_logged_in","You must be logged in to record media.")):u.data("ks-error",n.t("errors.load_failed","Media Comment Application failed to load.  Please try again."))})
var m=function e(){if(u.data("ks")){const e=p(i("SAfv"))
u.html(e())
i("Sv6n")
u.find("#media_record_tabs").tabs({activate:c.a.mediaComment.video_delegate.expectReady})
r()}else u.data("ks-error")?u.html(u.data("ks-error")):setTimeout(e,500)}
m()
d=c()("#media_comment_dialog")
d=u}}).bind(null,i)).catch(i.oe)}
...
void 0===e["zh-CN"]&&(e["zh-CN"]={"mejs.plural-form":0,"mejs.download-file":"下载文件","mejs.fullscreen-off":"关闭全屏","mejs.fullscreen-on":"转向全屏","mejs.download-video":"下载视频","mejs.fullscreen":"全屏","mejs.play":"播放","mejs.pause":"暂停","mejs.close":"关闭","mejs.time-slider":"时间滑动棒","mejs.time-help-text":"使用作/右箭头快进1秒，使用上/下箭头快进10秒。","mejs.time-skip-back":"后退%1秒","mejs.captions-subtitles":"字幕/标题","mejs.none":"无","mejs.mute-toggle":"静音切换","mejs.volume-help-text":"使用上/下箭头提高或降低音量。","mejs.unmute":"取消静音","mejs.mute":"静音","mejs.volume-slider":"音量选择键","mejs.video-player":"视频播放器","mejs.audio-player":"音频播放器"})})(mejs.i18n.locale.strings)},tSde:function(e,t,i){e.exports=i.p+"cd6dc830eb45b3a5a96bbc936ff54846.png"},tYpR:function(e,t){(function(e){"use strict"
void 0===e.en&&(e.en={"mejs.plural-form":1,"mejs.download-file":"Download File","mejs.fullscreen-off":"Turn off Fullscreen","mejs.fullscreen-on":"Go Fullscreen","mejs.download-video":"Download Video","mejs.fullscreen":"Fullscreen","mejs.time-jump-forward":["Jump forward 1 second","Jump forward %1 seconds"],"mejs.play":"Play","mejs.pause":"Pause","mejs.close":"Close","mejs.time-slider":"Time Slider","mejs.time-help-text":"Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.","mejs.time-skip-back":["Skip back 1 second","Skip back %1 seconds"],"mejs.captions-subtitles":"Captions/Subtitles","mejs.none":"None","mejs.mute-toggle":"Mute Toggle","mejs.volume-help-text":"Use Up/Down Arrow keys to increase or decrease volume.","mejs.unmute":"Unmute","mejs.mute":"Mute","mejs.volume-slider":"Volume Slider","mejs.video-player":"Video Player","mejs.audio-player":"Audio Player","mejs.ad-skip":"Skip ad","mejs.ad-skip-info":["Skip in 1 second","Skip in %1 seconds"],"mejs.source-chooser":"Source Chooser"})})(mejs.i18n.locale.strings)},teYS:function(e,t,i){const a=i("ouhR")
var o,n,s,r=a({})
...
//# sourceMappingURL=39-c-be703c995d.js.map